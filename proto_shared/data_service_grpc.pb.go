...
const (
	...
	CaseService_ListAllCases_FullMethodName     = "/kyc.data.CaseService/ListAllCases"
)
...
type CaseServiceClient interface {
	...
	ListAllCases(ctx context.Context, in *ListAllCasesRequest, opts ...grpc.CallOption) (*CaseList, error)
}
...
func (c *caseServiceClient) ListAllCases(ctx context.Context, in *ListAllCasesRequest, opts ...grpc.CallOption) (*CaseList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CaseList)
	err := c.cc.Invoke(ctx, CaseService_ListAllCases_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CaseServiceServer interface {
	...
	ListAllCases(context.Context, *ListAllCasesRequest) (*CaseList, error)
...
func (UnimplementedCaseServiceServer) ListAllCases(context.Context, *ListAllCasesRequest) (*CaseList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListAllCases not implemented")
}
...
func _CaseService_ListAllCases_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListAllCasesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CaseServiceServer).ListAllCases(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CaseService_ListAllCases_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CaseServiceServer).ListAllCases(ctx, req.(*ListAllCasesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CaseService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListAllCases",
			Handler:    _CaseService_ListAllCases_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto_shared/data_service.proto",
